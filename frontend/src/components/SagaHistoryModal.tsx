...
export const SagaHistoryModal: React.FC<SagaHistoryModalProps> = ({
  isOpen,
  onClose,
  onSelectOrder,
  onOpenAuth,
  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      ...
      >
        ...
        >
          <div>
            <h2 style={{ fontSize: '1.35rem' }}>
              Your Orders & Saga Lifecycle History
            </h2>
        ...
        {!isAuthenticated ? (
          <div
            style={{ textAlign: 'center', margin: 'auto 0', padding: '2rem' }}
          >
            <p
              style={{
                fontSize: '1rem',
          ...
          >
            ...
            <p style={{ fontSize: '0.85rem' }}>
              Place a standard or failure simulation order to view the live saga
              lifecycle
            </p>
          </div>
        ) : (
