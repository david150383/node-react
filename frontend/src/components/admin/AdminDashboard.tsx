...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    'PRODUCTS' | 'INVENTORY' | 'ORDERS' | 'USERS' | 'NOTIFICATIONS'
  >('PRODUCTS');
  ...
  if (!isAdmin) {
    return (
      ...
      >
        ...
        >
          You do not have administrative privileges to access the Operations
          Console. This area is restricted to authorized administrators.
        </p>
        <button
  ...
  return (
    <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
              Full-cluster governance across Product, Inventory, Order, Auth,
        ...
        >
            ...
            style={{
              ...
              background:
                activeTab === 'PRODUCTS'
                  ...
                  : 'transparent',
              color:
                activeTab === 'PRODUCTS' ? '#ffffff' : 'var(--text-secondary)',
              border: 'none',
            ...
            style={{
              ...
              background:
                activeTab === 'INVENTORY'
                  ...
                  : 'transparent',
              color:
                activeTab === 'INVENTORY' ? '#ffffff' : 'var(--text-secondary)',
              border: 'none',
              boxShadow:
                activeTab === 'INVENTORY' ? 'var(--shadow-sm)' : 'none',
            }}
          >
            <Layers size={15} />
            <span>Inventory</span>
            ...
            style={{
              ...
              background:
                activeTab === 'ORDERS'
                  ...
                  : 'transparent',
              color:
                activeTab === 'ORDERS' ? '#ffffff' : 'var(--text-secondary)',
              border: 'none',
            ...
            style={{
              ...
              background:
                activeTab === 'USERS'
                  ...
                  : 'transparent',
              color:
                activeTab === 'USERS' ? '#ffffff' : 'var(--text-secondary)',
              border: 'none',
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              boxShadow:
                activeTab === 'NOTIFICATIONS' ? 'var(--shadow-sm)' : 'none',
            }}
          >
            <Bell size={15} />
      ...
      {activeTab === 'ORDERS' && (
        <AdminOrderMonitor onInspectSaga={onInspectSaga} />
      )}
