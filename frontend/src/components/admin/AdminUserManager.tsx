...
export const AdminUserManager: React.FC = () => {
  ...
  const handleRoleToggle = async (targetUser: AdminUser) => {
    ...
    if (!window.confirm(`Change ${targetUser.email} role to ${nextRole}?`))
      return;
              ...
              {filteredUsers.map((u) => {
                ...
                return (
                  ...
                  >
                    <td style={{ padding: '1rem' }}>
                      ...
                      >
                        ...
                        <div>
                          ...
                          {isCurrent && (
                            <span
                              style={{ fontSize: '0.7rem', color: '#a5b4fc' }}
                            >
                              ● Current Session
                            </span>
                          )}
                    ...
                    <td style={{ padding: '1rem' }}>
                      <span
                        className={`badge ${u.role === 'ADMIN' ? 'badge-indigo' : 'badge-emerald'}`}
                      >
                        {u.role === 'ADMIN' ? (
                          <ShieldCheck size={12} />
                        ) : (
                    ...
                    <td style={{ padding: '1rem' }}>
                      <span
                        className={`badge ${u.is_active ? 'badge-emerald' : 'badge-rose'}`}
